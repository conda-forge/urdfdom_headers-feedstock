About urdfdom_headers-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/urdfdom_headers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/urdfdom_headers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add urdfdom_headers
# for installing globally
pixi global install urdfdom_headers
```
...
It is possible to list all of the versions of `urdfdom_headers` available on your platform:
...
```
pixi search urdfdom_headers --channel conda-forge
```
